...
try:
    # 测试新生成的文件
    df = pd.read_excel('外包结算单测试模版_extracted_20260316_235659.xlsx', sheet_name='工程结算金额')
    ...
    # 测试搬运结算金额工作表
    df2 = pd.read_excel('外包结算单测试模版_extracted_20260316_235659.xlsx', sheet_name='搬运结算金额')
